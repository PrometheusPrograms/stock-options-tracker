-- Migration: Change net_credit_per_share from NUMERIC(12,2) to NUMERIC(12,5)
-- This allows storing up to 5 decimal places while displaying 2 decimal places in the app
...
-- Create new trades table with net_credit_per_share as NUMERIC(12,5)
...
-- Copy data from old table to new table (no conversion needed, just copy as-is)
