-- Migration: Add ticker column to trades table
-- This field stores the ticker symbol associated with trades.ticker_id
-- This denormalizes the ticker for easier querying and display
...
-- Create new trades table with ticker column
...
-- Copy data from old table to new table, populating ticker from tickers table
INSERT INTO trades_new (
    id, account_id, ticker_id, ticker, trade_date, expiration_date, num_of_contracts, num_of_shares,
    ...
    margin_percent, ARORC, trade_type_id, trade_parent_id
)
SELECT
    t.id, t.account_id, t.ticker_id, tk.ticker, t.trade_date, t.expiration_date, t.num_of_contracts, t.num_of_shares,
    t.credit_debit, t.total_premium, t.days_to_expiration, t.current_price, t.strike_price,
    t.trade_status, t.trade_type, t.commission_per_share, t.created_at, t.price_per_share,
    t.total_amount, t.margin_capital, t.net_credit_per_share, t.risk_capital_per_share,
    t.margin_percent, t.ARORC, t.trade_type_id, t.trade_parent_id
FROM trades t
